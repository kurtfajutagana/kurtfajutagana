            ...
            {projects.map((proj, idx) => (
              ...
              >
                ...
                <div className="relative pt-2 flex flex-wrap items-center gap-4">
                  ...
                  >
                    <GithubIcon className="w-4 h-4" /> View Source Code <ExternalLink className="w-3.5 h-3.5 text-neutral-400" />
                  </a>
                </div>
              </div>
            ))}
